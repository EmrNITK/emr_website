      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-4 mb-6 border-b border-white/5 custom-scrollbar">
        {availableYears.map(year => (
          <button
            ...
            className={`px-5 py-2 rounded-lg text-sm font-medium transition-all whitespace-nowrap border ${activeYear === year
        ...
        {isModalOpen && (
          ...
          >
            <motion.div
              ...
              className={"relative bg-[#111111] border border-white/10 rounded-2xl w-full max-w-2xl max-h-[90vh] shadow-[0_0_40px_rgba(0,0,0,0.8)] custom-scrollbar "+(creationMode === 'new' && 'overflow-y-auto')}>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                {/* 1. Name Search Input & Dropdown Wrapper */}
                {/* Added relative positioning and a z-index here to anchor the dropdown */}
                <div className="relative z-30">
                  ...
                  {/* Dropdown moved inside the relative container and positioned with top-full */}
                  {showDropdown && (
