...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex items-center justify-between rounded-md border border-slate-200 bg-white data-[placeholder]:text-slate-500 outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-800 dark:bg-slate-950  dark:data-[placeholder]:text-slate-400",
      className
    )}
    {...props}>
    {children}
