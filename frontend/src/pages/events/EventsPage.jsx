    ...
    >
      ...
      <div className="md:w-7/12 p-6 md:p-8 flex flex-col">
            ...
            >
              {tab === 'overview' && (
                <div className="space-y-4">
                  ...
                  {event.status !== 'completed' && (<div className="flex flex-wrap gap-4 pt-2">
        ...
        <div className="pt-6 mt-6 border-t border-white/10 flex items-center justify-between">
               ...
               <Link to={"/p/events/"+event.slug} className="flex items-center gap-1 text-xs font-bold text-white group-hover:translate-x-1 transition-transform">
            ...
            {past.length > 0 && (
              <section>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-xl font-bold text-white/80">All Events</h2>
                </div>
