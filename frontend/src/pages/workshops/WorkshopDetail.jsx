...
const WorkshopDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-[#51b749]/30">
      ...
      {/* --- HERO SECTION --- */}
      <div className="relative h-[60vh] w-full overflow-hidden mt-14">
        ...
        <div className="relative z-10 h-full max-w-7xl mx-auto px-6 flex flex-col justify-end sm:pb-12 pb-8">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            {isUpcoming && (<div className="flex gap-3 mb-5">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tighter text-white mb-4">{workshop.title}</h1>
          </motion.div>
        </div>
      </div>
          ...
          <div className="sticky top-24 space-y-6">
            ...
            <div className="p-6 bg-[#111111] border border-white/10 rounded-2xl space-y-6 shadow-2xl shadow-black/50">
              ...
              <div className="pt-6 border-t border-white/5">
                ...
                <a href={workshop.regLink} target="_blank" rel="noreferrer" className="flex items-center justify-center gap-2 w-full py-4 bg-[#51b749] hover:bg-[#51b749]/80 text-white font-bold rounded-xl transition-all shadow-lg shadow-[#13703a]/20">
